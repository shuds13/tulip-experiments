...
opt -load libLLVMCudaFE.so -merge-kernel -mem2reg -indvars -dce fasten_linked.bc -o fasten_cpu.bc > cudafe_debug.txt

echo -e "\nPHASE 4: Running splendid decompiler on optimized bytecode"
/home/shudson/xcellent/llvm-install-debug/bin/splendid fasten_cpu.bc > splendid_debug.txt
